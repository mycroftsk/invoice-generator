...
$(document).ready(function(){$("#add_row").click(function(){var i=$('div[id^="item-"]:last'),e=parseInt(i.prop("id").match(/\d+/g),10)+1;i.clone().prop("id","item-"+e).insertAfter(i)}),$("#delete_row").click(function(){$('div[id^="item-"]').length>1&&$('div[id^="item-"]:last').remove()})});